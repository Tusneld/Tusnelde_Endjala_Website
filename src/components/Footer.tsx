...
const socialLinks = [
  { 
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/tusnelde-endjala-a65302253/', 
    color: '#0A66C2',
    icon: (
  ...
  { 
    label: 'X',
    href: 'https://x.com/TusneldeE', 
    color: '#1DA1F2',
    darkModeColor: '#1DA1F2',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  { 
    label: 'Instagram',
    href: 'https://www.instagram.com/endjalatusnelde/', 
    color: '#E4405F',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  { 
    label: 'Facebook',
    href: 'https://www.facebook.com/TusneldeEndjala', 
    color: '#1877F2',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  { 
    label: 'Email',
    href: 'mailto:tusneldelainae@gmail.com', 
    color: '#EA4335',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => {
                const displayColor = 'darkModeColor' in social ? social.color : social.color;
                const hoverColor = 'darkModeColor' in social ? (social as any).darkModeColor : social.color;
                return (
                  <motion.a
                    key={social.label}
                    href={social.href}
                    ...
                    className="p-2.5 rounded-lg bg-card border border-border transition-all duration-300"
                    style={{ color: displayColor }}
                    whileHover={{ 
                      scale: 1.15,
                      boxShadow: `0 0 20px ${hoverColor}60, 0 0 40px ${hoverColor}30`
                    }}
                    whileTap={{ scale: 0.9 }}
