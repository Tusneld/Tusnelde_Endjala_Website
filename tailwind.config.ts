  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-primary": "linear-gradient(135deg, hsl(var(--electric-blue)), hsl(var(--cyan-accent)))",
        "gradient-hero": "linear-gradient(180deg, hsl(var(--navy-deep)) 0%, hsl(var(--navy)) 100%)",
      },
    },
  },
